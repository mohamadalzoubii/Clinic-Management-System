...
readonly class UpdatePatientData
{
    ...
    public static function formRequest(Request $request): self
    {
        ...
        return new self(
            ...
            weight: Arr::has($validated, 'health_assessment.weight') ? (float) Arr::get($validated, 'health_assessment.weight') : null,
            height: Arr::has($validated, 'health_assessment.height') ? (float) Arr::get($validated, 'health_assessment.height') : null,
            gender: Arr::has($validated, 'personal_data.gender') ? Gender::from(Arr::get($validated, 'personal_data.gender')) : null,
            bloodType: Arr::has($validated, 'health_assessment.blood_type') ? BloodType::from(Arr::get($validated, 'health_assessment.blood_type')) : null,
        );
    }
